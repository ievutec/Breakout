		...
		class SampleListener extends Listener {
			...
			public void onFrame(Controller controller){
				...
				if(!frame.hands().isEmpty()) {
					...
					double MaxX = 50, MinX = -90;
					double xpos = pos.getX(), LenX = MaxX - MinX, Curlen;
					Curlen = MaxX - xpos;
					System.out.println(Curlen/LenX);
					double Curplace = getWidth()*(Curlen/LenX);
					double posit = getWidth()-Curplace;
					...
					paddle.setLocation(posit, getHeight() - PADDLE_Y_OFFSET - PADDLE_HEIGHT);
